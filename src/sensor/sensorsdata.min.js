...
var _ = {}, sa = {};
sa.para = conf, sa.status = {}, sa.para.openid_url || (sa.para.openid_url = sa.para.server_url.replace(/\/sa(\.gif){0,1}/, "/mp_login")), "number" != typeof sa.para.send_timeout && (sa.para.send_timeout = 1e3), sa.para.batch_send && (sa.para.use_client_time = !0), !0 === sa.para.batch_send && (sa.para.batch_send = {}, sa.para.batch_send.send_timeout = 6e3);
var ArrayProto = Array.prototype, FuncProto = Function.prototype, ObjProto = Object.prototype, slice = ArrayProto.slice,
    toString = ObjProto.toString, hasOwnProperty = ObjProto.hasOwnProperty, LIB_VERSION = "1.12.6",
...
if (logger.info = function () {
        ...
        var t, r, a, s, n, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", o = 0, c = 0,
            u = "", p = [];
        if (!e) return e;
        e = _.utf8Encode(e);
        do {
        ...
        var r = source_channel_standard.split(" "), a = source_channel_standard.split(" "), s = "", n = {};
        ...
        properties: {$lib: LIB_NAME, $lib_version: String(LIB_VERSION)}, getSystem: function () {
        ...
        this.prepareData({type: "track", event: e, properties: t}, r)
        ...
        if (_.info && _.info.properties && _.info.properties.$lib) {
            var e = _.extend({$url_path: _.getCurrentPath()}, _.info.properties, sa.store.getProps());
        ...
        hasNewData: !1, onAppHide: function () {
            sa.para.batch_send && this.batchSend()
        }, send: function (e) {
            sa.para.batch_send ? (this.hasNewData = !0, sa.store.mem.add(e)) : this.queueSend(e)
            ...
            t > 0 && this.wxrequest({data: e, len: t, success: this.batchRemove.bind(this)})
        }, batchRemove: function (e) {
            sa.store.mem.clear(e), this.hasNewData = !0, this.batchWrite()
        }, is_first_batch_write: !0, batchWrite: function () {
            var e = this;
            this.hasNewData && (this.is_first_batch_write && (this.is_first_batch_write = !1, setTimeout(function () {
                e.batchSend()
            }, 1e3)), this.hasNewData = !1, wx.setStorageSync("sensors_mp_prepare_data", sa.store.mem.mdata))
    ...
    }, _.each(["setProfile", "setOnceProfile", "track", "register", "clearAllRegister", "quick", "registerApp"], function (e) {
        var t = sa[e];
        sa[e] = function () {
        ...
        trackCustom: function (e, t, r) {
            ...
            var a = _.setUtm(e, r);
            is_first_launch ? (r.$is_first_time = !0, _.isEmptyObject(a.pre1) || sa.setOnceProfile(a.pre1)) : r.$is_first_time = !1, _.isEmptyObject(a.pre2) || sa.registerApp(a.pre2), e.scene = e.scene || "\u672a\u53d6\u5230\u503c", r.$scene = _.getMPScene(e.scene), sa.registerApp({$latest_scene: r.$scene}), r.$url_query = _.setQuery(e.query), t ? (r = _.extend(r, t), sa.track("$MPLaunch", r)) : sa.para.autoTrack && sa.para.autoTrack.appLaunch && sa.autoTrackCustom.trackCustom("appLaunch", r, "$MPLaunch")
        }, appShow: function (e, t) {
            var r = {};
            mpshow_time = (new Date).getTime(), e && e.path && (r.$url_path = _.getPath(e.path)), _.setShareInfo(e, r);
            var a = _.setUtm(e, r);
            _.isEmptyObject(a.pre2) || sa.registerApp(a.pre2), e.scene = e.scene || "\u672a\u53d6\u5230\u503c", r.$scene = _.getMPScene(e.scene), sa.registerApp({$latest_scene: r.$scene}), r.$url_query = _.setQuery(e.query), t ? (r = _.extend(r, t), sa.track("$MPShow", r)) : sa.para.autoTrack && sa.para.autoTrack.appShow && sa.autoTrackCustom.trackCustom("appShow", r, "$MPShow")
        }, appHide: function (e) {
        ...
        var e = arguments[0], t = arguments[1], r = arguments[2], a = {};
